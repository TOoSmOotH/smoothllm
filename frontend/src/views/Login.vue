<template>
  <div class="min-h-screen bg-bg-primary flex flex-col">
    ...
    <div class="flex-1 flex items-center justify-center bg-gradient-to-br from-bg-primary via-bg-primary to-bg-tertiary px-6 py-8 sm:px-8">
      ...
      <!-- Login Card -->
        <div class="bg-bg-secondary border border-border-subtle rounded-2xl p-6 sm:p-8 shadow-xl backdrop-blur-sm">
        <!-- Header -->
          ...
          <!-- Remember Me & Forgot Password -->
            ...
            <label class="flex items-center space-x-2 cursor-pointer min-h-[44px]">
              <input
                ...
                class="w-5 h-5 accent-primary-500 rounded border-border-default focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 focus:ring-offset-bg-secondary"
              />
            ...
            <button
              type="button"
              class="text-primary-500 hover:text-primary-600 text-sm font-medium transition-colors duration-200 min-h-[44px]"
            >
              Forgot password?
            </button>
            </div>
